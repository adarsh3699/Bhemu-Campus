...
import { Puzzle, ArrowRight, BarChart3, Users, Trophy } from "lucide-react";
...
export default function UMSSyncPrompt() {
	...
	return (
		<div className="w-full min-h-[calc(100vh-80px)] flex flex-col items-center justify-center p-4 md:p-6 relative bg-transparent overflow-hidden">
			...
			<div className="glass-panel backdrop-blur-xl rounded-3xl p-6 md:p-10 max-w-2xl w-full shadow-2xl relative overflow-hidden z-10">
